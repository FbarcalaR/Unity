...
public class StartOptions : MonoBehaviour {
    ...
    public int playerVsPlayerScene=2;
    public int aloneScene=1;
	...
	public void AloneClicked()
	{
		...
		//{
            ...
            StartCoroutine(FadeCanvasGroupAlpha(0f, 1f, fadeOutImageCanvasGroup, aloneScene));
  ...
  //      } 
    ...
    public void PlayerVSPlayerClicked()
    {
        //If changeMusicOnStart is true, fade out volume of music group of AudioMixer by calling FadeDown function of PlayMusic
        //To change fade time, change length of animation "FadeToColor"
        //if (menuSettingsData.musicLoopToChangeTo != null)
        ...
        //{
            ...
            StartCoroutine(FadeCanvasGroupAlpha(0f, 1f, fadeOutImageCanvasGroup, playerVsPlayerScene));
	...
	public void StartGameInScene()
	{
        ...
        StartCoroutine(FadeCanvasGroupAlpha(1f,0f, menuCanvasGroup, 0));
	}

    public IEnumerator FadeCanvasGroupAlpha(float startAlpha, float endAlpha, CanvasGroup canvasGroupToFadeAlpha, int sceneToStart)
    {
